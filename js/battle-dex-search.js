...
exports.BattlePokemonSuperSearch = void 0;
/**
...
var DexSearch = /** @class */ (function () {
    ...
    DexSearch.prototype.getTypedSearch = function (searchType, format, speciesOrSet) {
        ...
        switch (searchType) {
            ...
            case 'supersearch': return new BattlePokemonSuperSearch('pokemon', format, speciesOrSet);
        }
        return null;
    };
...
var BattleTypedSearch = /** @class */ (function () {
    ...
    BattleTypedSearch.prototype.nextLearnsetid = function (learnsetid, speciesid, checkingMoves) {
    ...
    BattleTypedSearch.prototype.canLearn = function (speciesid, moveid) {
        ...
        while (learnsetid) {
            ...
            if (learnset && (moveid in learnset) && (!this.format.startsWith('tradebacks') ? learnset[moveid].includes(genChar) :
                learnset[moveid].includes(genChar) || (learnset[moveid].includes("".concat(gen + 1)) && move.gen === gen)) &&
    ...
    BattleTypedSearch.prototype.eggMovesOnly = function (child, father) {
...
var BattlePokemonSearch = /** @class */ (function (_super) {
    ...
    BattlePokemonSearch.prototype.getBaseResults = function () {
        ...
        if ((format.endsWith('cap') || format.endsWith('caplc')) && dex.gen < 9) {
            ...
            this.formatType !== 'svdlc1doubles' && !((_b = this.formatType) === null || _b === void 0 ? void 0 : _b.includes('natdex')) &&
        ...
        else if ((_c = this.formatType) === null || _c === void 0 ? void 0 : _c.startsWith('bdsp')) {
        ...
        else if ((_d = this.formatType) === null || _d === void 0 ? void 0 : _d.startsWith('ssdlc1')) {
        ...
        else if ((_e = this.formatType) === null || _e === void 0 ? void 0 : _e.startsWith('predlc')) {
            if (this.formatType.includes('doubles')) {
        ...
        else if ((_f = this.formatType) === null || _f === void 0 ? void 0 : _f.startsWith('svdlc1')) {
            if (this.formatType.includes('doubles')) {
        ...
        else if (((_g = this.formatType) === null || _g === void 0 ? void 0 : _g.startsWith('bdsp')) || this.formatType === 'letsgo' || this.formatType === 'stadium') {
            tierSet = tierSet.slice(slices.Uber);
        }
...
var BattlePokemonSuperSearch = /** @class */ (function (_super) {
    __extends(BattlePokemonSuperSearch, _super);
    function BattlePokemonSuperSearch() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.sortRow = ['sortpokemon', ''];
        return _this;
    }
    BattlePokemonSuperSearch.prototype.getTable = function () {
        return BattlePokedex;
    };
    BattlePokemonSuperSearch.prototype.getDefaultResults = function () {
        var results = [];
        for (var id in BattlePokedex) {
            switch (id) {
                case 'bulbasaur':
    ...
    BattlePokemonSuperSearch.prototype.getBaseResults = function () {
        var _a, _b, _c, _d, _e, _f, _g;
        var format = this.format;
        if (!format)
            return this.getDefaultResults();
    ...
    BattlePokemonSuperSearch.prototype.filter = function (row, filters) {
        if (!filters)
            return true;
        if (row[0] !== 'pokemon')
            return true;
    ...
    BattlePokemonSuperSearch.prototype.sort = function (results, sortCol, reverseSort) {
        var _this = this;
        var sortOrder = reverseSort ? -1 : 1;
        if (['hp', 'atk', 'def', 'spa', 'spd', 'spe'].includes(sortCol)) {
            return results.sort(function (_a, _b) {
    ...
    return BattlePokemonSuperSearch;
}(BattleTypedSearch));
exports.BattlePokemonSuperSearch = BattlePokemonSuperSearch;
...
var BattleMoveSearch = /** @class */ (function (_super) {
    ...
    BattleMoveSearch.prototype.moveIsNotUseless = function (id, species, moves, set) {
        ...
        switch (id) {
            ...
            case 'dazzlinggleam':
                return !moves.includes('alluringvoice') || ((_a = this.formatType) === null || _a === void 0 ? void 0 : _a.includes('doubles'));
            case 'darkvoid':
                return dex.gen < 7;
            case 'dualwingbeat':
    ...
    BattleMoveSearch.prototype.getBaseResults = function () {
        ...
        if ((_b = this.formatType) === null || _b === void 0 ? void 0 : _b.startsWith('ssdlc1'))
            lsetTable = lsetTable['gen8dlc1'];
        if ((_c = this.formatType) === null || _c === void 0 ? void 0 : _c.startsWith('predlc'))
            lsetTable = lsetTable['gen9predlc'];
        if ((_d = this.formatType) === null || _d === void 0 ? void 0 : _d.startsWith('svdlc1'))
        ...
        while (learnsetid) {
            ...
            if (learnset) {
                for (var moveid in learnset) {
                    ...
                    if (((_e = this.formatType) === null || _e === void 0 ? void 0 : _e.startsWith('dlc1')) &&
                        ((_f = BattleTeambuilderTable['gen8dlc1']) === null || _f === void 0 ? void 0 : _f.nonstandardMoves.includes(moveid))) {
                        continue;
                    }
                    if (((_g = this.formatType) === null || _g === void 0 ? void 0 : _g.includes('predlc')) && this.formatType !== 'predlcnatdex' &&
                        ((_h = BattleTeambuilderTable['gen9predlc']) === null || _h === void 0 ? void 0 : _h.nonstandardMoves.includes(moveid))) {
                        continue;
                    }
                    if (((_j = this.formatType) === null || _j === void 0 ? void 0 : _j.includes('svdlc1')) && this.formatType !== 'svdlc1natdex' &&
                        ((_k = BattleTeambuilderTable['gen9dlc1']) === null || _k === void 0 ? void 0 : _k.nonstandardMoves.includes(moveid))) {
                        continue;
                    }
            ...
            for (var id in this.getTable()) {
                ...
                for (var i = dex.gen; i >= species.gen && i >= move.gen; i--) {
                    ...
                    if (baseSpecies.otherFormes && !['Wormadam', 'Urshifu'].includes(baseSpecies.baseSpecies)) {
                        ...
                        for (var _i = 0, _l = baseSpecies.otherFormes; _i < _l.length; _i++) {
                            var formeName = _l[_i];
                ...
                var valid = false;
                for (var _m = 0, moveTypes_1 = moveTypes; _m < moveTypes_1.length; _m++) {
                    var type = moveTypes_1[_m];
        ...
        for (var _p = 0, sketchMoves_1 = sketchMoves; _p < sketchMoves_1.length; _p++) {
            var id = sketchMoves_1[_p];
